                        ...
                        <div class="card-body" style="margin-left:60px;">
                            ...
                            <form action="update_staff_handle.php" method="POST" onsubmit="return validate();" enctype="multipart/form-data" id="myform">
                               ...
                               <div class="row">
                                  <div class="col-sm-4">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1" style="font-weight: bold;">Dob</label>
                                        <input type="text" class="form-control datepicker" name="dob" id="dob" aria-describedby="emailHelp" required value="<?php echo $lata['dob']; ?>">
                                    </div>
                                  </div>
                                <div class="col-sm-3">
                                  <div class="form-group">
                                      <label for="exampleInputEmail1" style="font-weight: bold;">Age</label>
                                      <input type="text" class="form-control" name="age" id="age" aria-describedby="emailHelp" required value="<?php echo $lata['age']; ?>" readonly>
                                  </div>
                                </div>
                              </div>
                               ...
                               <div class="row">
                                ...
                                <button type="submit" class="btn btn-primary mb-0">Update Staff</button>
