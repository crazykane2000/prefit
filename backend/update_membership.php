...
<body id="app-container" class="menu-default show-spinner">
    ...
    <main>
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    <h1>Update Primary Membership</h1>         
                            ...
                            <h5 class="mb-4">Basic Informations</h5>
                             <form action="update_membership_handle.php" method="POST" onsubmit="return validate_form();" id="myform">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="numbe" class="form-control" name="membership_period" id="membership_period" placeholder="Membership Period In Months" value="<?php echo $lata['membership_period']; ?>" required>
                                </div>
