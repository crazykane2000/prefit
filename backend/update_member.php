                ...
                <div class="col-lg-8">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <form action="update_member_handle.php" method="POST" onsubmit="return validate_input();" id="myform">

                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="membershiptype" style="font-weight: bold;">Membership Type</label>
                                            <select class="form-control" name="membership_type" id="member_pack" required>
                                                <?php 
                                                echo '<option value="">'. $lata['membership_type'].'</option>';
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="exampleInputPassword1" style="font-weight: bold;">Other Number</label>
                                    <input type="text" class="form-control" name="phone_number2" id="phone_number2" placeholder="Phone Number" value="<?php echo $lata['phone_number2'];?>">
                                </div>
                            </div>
                          </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-check-inline">
                                        <input class="form-check-input" type="radio" name="gender" id="gender" value="Male" <?php if($lata['gender']=='Male') echo 'checked="checked"';?>>
                                    ...
                                    <div class="form-check-inline">
                                        <input class="form-check-input" type="radio" name="gender" id="gende2" value="Female" <?php if($lata['gender']=='Female') echo 'checked="checked"';?>>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select  name="prof_state" id="state1" style="border-radius:5px;width:95%;border:solid 1px #ddd;padding:10px;">
                                        <option><?php echo $lata['state'];?></option>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="city" id="city" placeholder="Enter City Name" value="<?php echo $lata['city'];?>">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                             ...
                             <div class="col-sm-6">
                                  <div class="form-group">
                                      ...
                                      <input type="email" class="form-control" name="email" id="email" value="<?php echo $lata['email']?>">
                                  </div>
                              </div>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="occupation" id="occupation" placeholder="Occupation" value="<?php echo $lata['occupation'];?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="marital_status" id="marital_status">
                                                <option><?php echo $lata['marital_status'];?></option>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <label>From :</label>
                                            <input type="text" class="form-control datepicker" name="validity_from" id="validity_from" placeholder="Choose From Date" value="<?php echo $lata['validity_from'];?>">
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group" style="margin-top: 8px;">
                                            ...
                                            <input type="text" class="form-control datepicker" name="validity_to" id="validity_to" placeholder="Choose To Date"
                                             value="<?php echo $lata['validity_to'];?>">
                                        </div>
                                    </div>
                              </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="total_amount" id="total_amount" value="<?php echo $lata['total_amount'];?>" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="paid_amount" id="paid_amount" placeholder="0.00" value="<?php echo $lata['paid_amount'];?>" readonly>
                            ...
                            <div class="col-sm-6">
                             ...
                             <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="remarks" class="form-control" id="remarks"><?php echo $lata['remarks'];?></textarea>
                                </div></div>
                            </div>
                            ...
                            <button type="submit" class="btn btn-primary mb-0">Update Member</button>
                            </form>
