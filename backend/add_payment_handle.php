<?php session_start();
    ...
    echo $member_id;
    $lata = get_data_id_data("member", "member_id", $member_id);
    print_r($lata);
    ...
    if($_REQUEST['pay_amount']<1){
       ...
       $stmt2->execute();
        ...
        header('Location:after_payment_modal.php?8d1d4357e1e1c6b3e4ea6df4ff01fede='.base64_encode($lata['id']).'&choice=success&value=Payment Added Successfully'); 
        exit();
?>
