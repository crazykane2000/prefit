<?php session_start();
    ...
    $key_list = " `enquiry_id`, `name`, `phone`, `phone2`, `email`,  `address`, `occupation`, `dob`,  `age`, `gender`, `had_gym_before`, `issue_with_previous_gym`, `any_health_issue`, `health_issue`, `purpose`, `service`, `reference_from_media`, `following_by`, `date`";    
