                ...
                <div class="col-lg-6">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <form action="update_new_enquiry_handle.php" id="myform" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="enquiry_for" multiple="multiple" name="enquiry_for[]">
                                        <option><?php $lata['service']; ?></option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="goal[]" id="goal" multiple="multiple">
                                            <option><?php echo $lata['purpose']; ?></option>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="<?php echo $lata['name']; ?>" name="name" id="exampleInputEmail1" aria-describedby="emailHelp"
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1" style="font-weight: bold;">Email ID</label>
                                    <input type="email" class="form-control" value="<?php echo $lata['email']; ?>" name="email" id="exampleInputEmail1" aria-describedby="emailHelp"
                            ...
                            <div class="row">
                              <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="phone" id="exampleInputPassword1" placeholder="Phone Number" value="<?php echo $lata['phone']; ?>" required>
                                </div>
                             </div>
                             ...
                             <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="phone2" id="exampleInputPassword1" placeholder="Optional" value="<?php echo $lata['phone2']; ?>" required>
                                </div>
                             </div>
                           </div>
                                ...
                                <!-- <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="phone" value="<?php echo $lata['phone']; ?>" id="exampleInputPassword1" placeholder="Phone Number">
                                </div>
 -->
                                <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="<?php echo $lata['occupation']; ?>" class="form-control" name="occupation" id="exampleInputPassword1" placeholder="Occupation">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-check-inline">
                                                <input class="form-check-input" type="radio" name="gender" id="gender" <?php if ($lata['gender'] == 'Male') echo 'checked="checked"'; ?> value="Male" required>
                                                <label class="form-check-label" for="gender">
                                                    Male
                                                </label>
                                            </div>
                                            <div class="form-check-inline">
                                                <input class="form-check-input" type="radio" name="gender" id="gende2" <?php if ($lata['gender'] == 'Female') echo 'checked="checked"'; ?> value="Female">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="age" id="age" value="<?php echo $lata['age']?>" readonly>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label for="exampleInputPassword1" style="font-weight: bold;color: green">Had Gym Before</label><br/>
                                            <div class="form-check-inline" style="display: inline-block;">
                                                <input class="form-check-input" type="radio" name="had_gym_before" id="gridRadios1" <?php if ($lata['had_gym_before'] == 'yes') echo 'checked="checked"'; ?> value="Yes" >
                                            ...
                                            <div class="form-check-inline" style="display: inline-block;">
                                                <input class="form-check-input" <?php if ($lata['had_gym_before'] == 'No') echo 'checked="checked"'; ?> type="radio" name="had_gym_before" id="gridRadios2" value="No" >
                                   ...
                                   <div class="col-sm-12">
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Name the gym and why you left?</label>
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label for="exampleInputPassword1" style="font-weight: bold;color: green">Any Health Issues?</label><br/>
                                            <div class="form-check-inline" style="display: inline-block;">
                                                <input class="form-check-input" type="radio" name="any_health_issue" <?php if ($lata['any_health_issue'] == 'yes') echo 'checked="checked"'; ?> id="any_health_issue" value="Yes" >
                                            ...
                                            <div class="form-check-inline" style="display: inline-block;">
                                                <input class="form-check-input" type="radio" name="any_health_issue" <?php if ($lata['any_health_issue'] == 'No') echo 'checked="checked"'; ?> id="any_health_issue2" value="No" >
                                   ...
                                   <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="health_issue" class="form-control" id="exampleInputPassword1" placeholder="Please Write your issues"><?php echo $lata['health_issue']; ?></textarea>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="reference_from_media" id="exampleInputPassword1">
                                                <?php echo '<option>'.$lata['reference_from_media'].'</option>'; ?>
                                   ...
                                   <div class="col-sm-6">
                                     <div class="form-group">
                                      <label for="exampleInputPassword1" style="font-weight: bold;">Date</label>
                                       <input type="text" name="date" id="date" class="form-control datepicker" placeholder="Choose Date" value="<?php echo $lata['date']?>">
                                     </div>
                                   </div>


                                </div>
                                <button type="submit" class="btn btn-primary mb-0">Update New Enquiry</button>
                            </form>
